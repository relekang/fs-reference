...
urlpatterns += i18n_patterns('',
    ...
    url(r'^api/', include('fs_ref.api.urls')),
    url(r'^comments/edit/(?P<comment_id>\d+)/$', 'fs_ref.app.comments.views.edit_comment', name='edit_comment'),
    url(r'^comments/delete/(?P<comment_id>\d+)/$', 'fs_ref.app.comments.views.delete_comment', name='delete_comment'),
